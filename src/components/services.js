...
const Services = () => {
  return (
      ...
      <div className="main-section-six" id="doen-wij">
        <div className="services-container">
          <div className="services-intro">
            ...
            <div className="detail-services-container">
          ...
          <div className="services">
            <div className={`services-strategy service`}>
              ...
              <p>
                ...
                ons volledig in uw(of de klant) en proberen vanuit dit
                perspectief mee te denken. We brengen quality time door met onze
                klanten om te ontdekken waar hun merk echt voor staat & ons te
                verdiepen in het bedrijf. Onze UX-designers analyseren de
                concurrentie en kijken hoe wij hun voor kunnen zijn.
              </p>
            </div>
